...
const Header = () => {
  ...
  return (
    <div className="bg-[#9EF01A] font-title">
      <div className="flex mx-auto w-11/12 justify-between items-center p-4">
